              ...
              <tbody className="h-96 overflow-y-auto">
                {groupedFindings.map((finding: IGroupedFinding) => (
                  <React.Fragment key={finding.id}>
                    ...
                    >
                      <td className="border p-2">{finding.id}</td>
                      ...
                      <td className="border p-2">{finding.security_analyst}</td>
                      <td className="border p-2">{finding.owner}</td>
                      <td className="border p-2">{finding.workflow}</td>
